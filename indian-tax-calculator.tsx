...
export default function IndianTaxCalculator() {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-800 dark:to-gray-900 shadow-xl">
      <CardHeader className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white p-6 rounded-t-lg">
        <CardTitle className="text-3xl font-bold text-center">Tax Calculator for 2025-26</CardTitle>
      </CardHeader>
      <CardContent className="p-6">
        ...
        {income && Number.parseFloat(income) <= 1200000 && (
          <Alert className="mt-6 bg-green-100 border-green-400 text-green-700 dark:bg-green-900 dark:border-green-700 dark:text-green-100">
            ...
            <AlertDescription>
              Your annual income is ₹{Number.parseFloat(income).toLocaleString()} which is not taxable. There is no tax
              applicable for annual income up to ₹12,00,000.
            </AlertDescription>
          </Alert>
        )}
        ...
        {totalTax > 0 && (
          <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg p-6 shadow-inner">
            <h3 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-white">Tax Breakdown</h3>
            <table className="w-full">
              ...
              <tfoot>
                <tr className="font-bold text-lg">
                  ...
                  <td className="text-right py-2 text-blue-600 dark:text-blue-400">₹{totalTax.toFixed(2)}</td>
                </tr>
              </tfoot>
            </table>
          </div>
